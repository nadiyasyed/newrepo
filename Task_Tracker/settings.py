...
DATABASES = {
    'default': {
        ...
        'NAME': 'task_tracker',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'r$5bop6t-6@cbnqm4e(wfbh)0wmy40a4htftdd07r!6!rjn0c$'
...
TEMPLATE_DIRS = (
                # os.path.join(os.path.dirname(__file__),'Apps/accounts/Templates'),
